...
def derivation_steps_backdoor(
    ...
    steps = [
        ...
        "  • In the graph with edges into X removed, conditioning on Z d-separates X from Y on all backdoor paths.",
        "  • Rule 2 (action/observation exchange): under this condition,",
        "    P(Y | do(X), Z) = P(Y | X, Z).",
